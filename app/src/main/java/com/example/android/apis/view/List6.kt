...
class List6 : AppCompatActivity() {
    ...
    public override fun onCreate(savedInstanceState: Bundle?) {
        ...
        list.adapter = SpeechListAdapter(mContext = this)
     ...
     * @param dialogue the contents of the speech.
     * @param expanded if `true` the [TextView] holding our [dialogue] ([mDialogue]) is visible.
     */
