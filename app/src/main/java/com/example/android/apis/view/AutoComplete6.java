...
public class AutoComplete6 extends Activity {
     ...
     * contains a TextView to use when instantiating views. We set {@code MultiAutoCompleteTextView textView}
     * by finding the view with ID R.id.edit, and set its adapter to {@code adapter}. Finally we set
     * the Tokenizer of {@code textView} that will be used to determine the relevant range of the text
     * where the user is typing to a new instance of {@code MultiAutoCompleteTextView.CommaTokenizer}.
     *
