...
class AutoComplete6 : AppCompatActivity() {
     ...
     * We create `ArrayAdapter<String> adapter` using our array `COUNTRIES` as the data
     * and android.R.layout.simple_dropdown_item_1line as the resource ID for the layout file which
     * contains a TextView to use when instantiating views. We set `MultiAutoCompleteTextView textView`
     * by finding the view with ID R.id.edit, and set its adapter to `adapter`. Finally we set
     * the Tokenizer of `textView` that will be used to determine the relevant range of the text
     * where the user is typing to a new instance of `MultiAutoCompleteTextView.CommaTokenizer`.
     *
