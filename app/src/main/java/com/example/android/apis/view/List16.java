...
public class List16 extends ListActivity {
     ...
     * list adapter to a new instance of {@code ArrayAdapter} constructed to display the array
     * {@code Cheeses.sCheeseStrings} using the layout android.R.layout.simple_list_item_activated_1.
     *
    ...
    private class ModeCallback implements ListView.MultiChoiceModeListener {
         ...
         * the title of our parameter {@code ActionMode mode} to the string "Select Items", and then
