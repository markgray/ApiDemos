...
public class CustomTitle extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        final TextView leftText = findViewById(R.id.left_text);
        final TextView rightText = findViewById(R.id.right_text);
        final EditText leftTextEdit = findViewById(R.id.left_text_edit);
        final EditText rightTextEdit = findViewById(R.id.right_text_edit);
        Button leftButton = findViewById(R.id.left_text_button);
        Button rightButton = findViewById(R.id.right_text_button);
