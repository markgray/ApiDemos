...
class AutoComplete1 : AppCompatActivity() {
     ...
     * contains a TextView to use when instantiating views. We set `AutoCompleteTextView textView`
     * by finding the view with ID R.id.edit, and set its adapter to `adapter`.
     *
