 ...
 */
class LayoutAnimation5 : AppCompatActivity() {
    /**
     * Called when the activity is starting. First we call through to our super's implementation of
     * `onCreate`, then we set our content view to our layout file R.layout.layout_animation_5.
     ...
     * finding the view with the ID R.id.grid, and set its adapter to a new instance of [AppsAdapter].
     *
