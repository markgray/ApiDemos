...
class AlertDialogSamples : Activity() {
        ...
        when (id) {
            ...
            -> {
                ...
                mProgressDialog!!.setButton(DialogInterface.BUTTON_POSITIVE,
                        getText(R.string.alert_dialog_hide)) { dialog, whichButton -> /*Yes*/ }
                mProgressDialog!!.setButton(DialogInterface.BUTTON_NEGATIVE,
                        getText(R.string.alert_dialog_cancel)) { dialog, whichButton -> /*No*/ }
            ...
            -> return AlertDialog.Builder(this@AlertDialogSamples)
                    ...
                    .setSingleChoiceItems(R.array.select_dialog_items2, 0) { dialog, whichButton -> /*radio button clicked*/ }
            ...
            -> {
                val projection = arrayOf(ContactsContract.Contacts._ID, ContactsContract.Contacts.DISPLAY_NAME, ContactsContract.Contacts.SEND_TO_VOICEMAIL)
                ...
                return AlertDialog.Builder(this@AlertDialogSamples)
                        ...
                        .setMultiChoiceItems(cursor,
                            ...
                            Toast.makeText(this@AlertDialogSamples,
            ...
            -> return AlertDialog.Builder(this@AlertDialogSamples, AlertDialog.THEME_TRADITIONAL)
            ...
            -> return AlertDialog.Builder(this@AlertDialogSamples, AlertDialog.THEME_DEVICE_DEFAULT_LIGHT)
                    .setTitle(R.string.alert_dialog_two_buttons_title)
                    .setPositiveButton(R.string.alert_dialog_ok) { dialog, whichButton -> /*ok*/ }
                    .setNegativeButton(R.string.alert_dialog_cancel) { dialog, whichButton -> /*cancel*/ }
                    .create()
            DIALOG_YES_NO_DEFAULT_DARK_MESSAGE // OK Cancel dialog with DeviceDefault theme
            -> return AlertDialog.Builder(this@AlertDialogSamples, AlertDialog.THEME_DEVICE_DEFAULT_DARK)
                    .setTitle(R.string.alert_dialog_two_buttons_title)
                    .setPositiveButton(R.string.alert_dialog_ok) { dialog, whichButton -> /*ok*/ }
                    .setNegativeButton(R.string.alert_dialog_cancel) { dialog, whichButton -> /*cancel*/ }
                    .create()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mRoot = findViewById<View>(android.R.id.content) as ViewGroup // In order to have a rootView for inflate

        /* Display a text message with yes/no buttons and handle each message as well as the cancel action */
        val twoButtonsTitle = findViewById<View>(R.id.two_buttons) as Button // OK Cancel dialog with DeviceDefault theme
        ...
        val twoButtons2Title = findViewById<View>(R.id.two_buttons2) as Button // OK Cancel dialog with a long message
        ...
        val twoButtons2UltraTitle = findViewById<View>(R.id.two_buttons2ultra) as Button // OK Cancel dialog with ultra long message
        ...
        val progressButton = findViewById<View>(R.id.progress_button) as Button // Progress bar dialog
        ...
        /* Display a custom progress bar */
        val progressSpinnerButton = findViewById<View>(R.id.progress_spinner_button) as Button // Progress spinner dialog
        ...
        val checkBox2 = findViewById<View>(R.id.checkbox_button2) as Button // Send Call to VoiceMail
        ...
        val twoButtonsOldSchoolTitle = findViewById<View>(R.id.two_buttons_old_school) as Button // OK Cancel dialog with traditional theme
        ...
        val twoButtonsHoloLightTitle = findViewById<View>(R.id.two_buttons_holo_light) as Button // OK Cancel dialog with Holo Light theme
        ...
        val twoButtonsDefaultLightTitle = findViewById<View>(R.id.two_buttons_default_light) as Button // OK Cancel dialog with DeviceDefault Light theme
        twoButtonsDefaultLightTitle.setOnClickListener { showDialog(DIALOG_YES_NO_DEFAULT_LIGHT_MESSAGE) }

        /* Two points, in the dark default theme */
        val twoButtonsDefaultDarkTitle = findViewById<View>(R.id.two_buttons_default_dark) as Button // OK Cancel dialog with DeviceDefault theme
        twoButtonsDefaultDarkTitle.setOnClickListener { showDialog(DIALOG_YES_NO_DEFAULT_DARK_MESSAGE) }
    ...
    companion object {
        ...
        private const val DIALOG_YES_NO_ULTRA_LONG_MESSAGE = 9 // OK Cancel dialog with ultra long message
        private const val DIALOG_YES_NO_OLD_SCHOOL_MESSAGE = 10 // OK Cancel dialog with traditional theme
        private const val DIALOG_YES_NO_HOLO_LIGHT_MESSAGE = 11 // OK Cancel dialog with Holo Light theme
        private const val DIALOG_YES_NO_DEFAULT_LIGHT_MESSAGE = 12 // OK Cancel dialog with DeviceDefault Light theme
        private const val DIALOG_YES_NO_DEFAULT_DARK_MESSAGE = 13 // OK Cancel dialog with DeviceDefault theme
        ...
        private var mProgressHandler: Handler? = null // Handler which "moves" the ProgressDialog progress setting
    }
}
