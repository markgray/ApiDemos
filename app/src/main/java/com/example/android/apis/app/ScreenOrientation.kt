...
import com.example.android.apis.app.ScreenOrientation.Companion.mOrientationValues
...
class ScreenOrientation : AppCompatActivity() {
    ...
    companion object {
         ...
         */
        val mOrientationValues: IntArray = intArrayOf(
         ...
         */
        val mOrientationDescriptions: Array<String> = arrayOf(
